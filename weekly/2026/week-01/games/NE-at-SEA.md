...
Seattle expected Price to make his NFL game debut in the opener after no preseason game appearances. Treat the expectation as availability progress; it supplies no measured early-down, route, protection or goal-line split with Holani and Wilson.
...
|---|---|---|---|---|
| Jadarian Price | Debut expected; workload range remains wide | Medium | No preseason game usage to establish the split | Week 1 opening-drive routes and goal-line snaps |
| TreVeyon Henderson | Conditional; prepare replacement | Low | September 5 assessment pending | Official participation and final designation |
