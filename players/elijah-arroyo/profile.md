---
schema_version: 1
record_id: pp-all-elijah-arroyo-001
record_type: player_profile
title: "Elijah Arroyo"
team_ids: ["SEA"]
player_ids: ["local-player-elijah-arroyo-2025"]
season: null
week: null
status: active
...
A receiving-oriented tight-end prospect with developmental upside. Seattle’s July camp preview emphasizes his athletic receiving ability, while identifying both him and Barner as potential beneficiaries of Fleury’s arrival. That is an opportunity hypothesis rather than established target volume.

### Historical usage and production

| Season | Team | Receptions | Receiving yards | TD |
|---|---|---|---|---|
| 2024 | Miami (college) | 35 | 590 | 7 |
| 2025 | SEA | 15 | 179 | 1 |

The club biography lists four starts in 13 NFL games in 2025. College and NFL rows are separate levels of competition, not an efficiency trend.

### Strengths, limitations, and relevant context

His first NFL season offers a small receiving sample, and the team biography documents injury-limited college seasons in 2022–2023. Draft investment supports developmental interest, not an automatic starting assignment.

## Current situation

### Team and depth-chart role

Competes for receiving assignments in a tight-end group led by Barner and including Saubert. The existence of multiple playable tight ends makes personnel usage central to the projection.

### Coaching/scheme fit

ARCH inference: two-tight-end formations could place Arroyo on routes while Barner blocks, or add opportunities for both. A coordinator’s tight-end background cannot establish which player receives the incremental targets.
...
- Key upside condition: Routes on a substantial share of team dropbacks, particularly when paired with Barner, plus identifiable red-zone involvement.
- Key downside condition: Limited personnel usage, continued blocking development or routes concentrated on the established receivers.
- Confidence: medium on the historical role description; low on precise current opportunity.

## Team history

Miami, 2021–2024. Seattle selected him in Round 2, 50th overall, in 2025. The official bio header and transaction line disagree by a day on the draft date; no exact day is needed for this record.
