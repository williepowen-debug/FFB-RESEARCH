---
schema_version: 1
record_id: rf-2026-lac-herbert-protection-001
record_type: research_finding
title: "Herbert's new structure depends on a rebuilt offensive line"
team_ids: ["LAC"]
player_ids: []
season: 2026
week: null
...
# Finding: Herbert's new structure depends on a rebuilt offensive line

## Scope

- Team/player: Los Angeles Chargers offense; Justin Herbert; offensive line
...
- Herbert's ceiling rises if play action, motion, and quicker timing reduce negative plays without suppressing downfield attempts.
- Better early-down efficiency would create more touchdown drives and stabilize every Chargers pass catcher.
- If the line still leaks inside, McDaniel may compensate with shorter throws, extra blocking help, and fewer routes, lowering the ceiling of the passing game even if Herbert remains functional.
- The quality of the protection improvement matters more than the nominal depth-chart upgrade.
...
- Los Angeles Chargers — [Why the Chargers prioritized the offensive line in the draft](https://www.chargers.com/news/2026-draft-class-takeaways-joe-hortiz) — published 2026-04-25.
...
- Confidence: medium
- Reason: The problem, investments, and intended mitigation are well documented, but the rebuilt five has no regular-season sample together.
- Fact/inference boundary: Personnel moves, injuries, 2025 pressure totals, and public scheme descriptions are reported facts. Improved protection and fantasy efficiency are projections.
- What would invalidate this: Persistent interior leakage, repeated stunt/pressure errors, heavy chip or max-protection usage, or a pressure/sack rate close to the 2025 baseline.
- Next review: Each preseason game, then the first two regular-season games with line combination, pressure, sack, route-release, and play-action charting.
