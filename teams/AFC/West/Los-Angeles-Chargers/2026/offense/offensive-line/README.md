---
schema_version: 1
record_id: rf-2026-lac-offensive-line-overview-001
record_type: research_finding
title: "Los Angeles Chargers 2026 offensive line unit overview"
team_ids: ["LAC"]
player_ids: []
season: 2026
week: null
...
# Los Angeles Chargers 2026 offensive line
...
The projected lineup, team-issued depth chart, reported availability, Houston deployment and coach descriptions establish the current baseline. Claims about unit rank and future first-unit execution remain projections.
...
6. **Early reserve execution.** The Houston group supported 379 yards, 23 first downs and four drives of at least eight plays.
...
1. **Tackle availability:** especially Slater's response to consecutive football workloads.
2. **Left-guard resolution:** not just who wins, but whether the winner improves the five-man operation.
3. **Five-man protection:** identification and exchanges against fronts, twists, simulated pressure and obvious passing downs.

## Fantasy implication

- **Justin Herbert:** stable five-man protection raises both efficiency and downfield volume; scheme-only mitigation can improve sacks without creating the same ceiling.
- **Omarion Hampton:** coordinated zone blocking and cleaner first contact support a workhorse rushing floor, but line quality does not establish his routes or goal-line share.
- **Wide receivers:** McConkey, Johnston and Harris benefit most if tackles hold without chips and the offense preserves intermediate and deep routes.
- **Tight ends and backs:** route participation must be separated from snaps because protection help can erase fantasy opportunity.

## Module map

- [`personnel.md`](personnel.md): projected starters, left-guard competition and reserve inventory.
- [`run-blocking.md`](run-blocking.md): concept fit, early Houston evidence and charting plan.
- [`pass-protection.md`](pass-protection.md): risk map and responsibility taxonomy.
- [`depth-and-contingencies.md`](depth-and-contingencies.md): injury responses and lineup-change costs.
- [`fantasy-impact.md`](fantasy-impact.md): player-specific transmission and matchup rules.
- [`monitoring.md`](monitoring.md): live questions, evidence hierarchy and update triggers.
- [`../herbert-protection-and-structure.md`](../herbert-protection-and-structure.md): companion finding on the 2025 pressure failure and McDaniel's structural response.
- [`../../preseason/evidence-log.csv`](../../preseason/evidence-log.csv): dated observations that test this durable assessment.
...
- Los Angeles Chargers — [Rashawn Slater discusses his managed return](https://www.chargers.com/news/rashawn-slater-knee-injury-rehab-2026) — published 2026-08-11.
- Los Angeles Chargers — [Houston opener takeaways and line deployment](https://www.chargers.com/news/texans-preseason-takeaways-jake-slaughter-2026) — published 2026-08-14.
- Los Angeles Chargers — [Young linemen and the August 16 left-guard rotation](https://www.chargers.com/news/training-camp-report-travis-burke-day-14) — published 2026-08-16.
