# Los Angeles Chargers 2026 Preseason Intelligence
...
- [`monitoring-priorities.csv`](monitoring-priorities.csv): ten operational questions distilled from the offense and defense hypothesis files.
...
Current depth chart: [`2026-08-16-unofficial.md`](depth-charts/2026-08-16-unofficial.md)
...
The team depth chart is explicitly unofficial. It establishes the published order but does not establish snap share, routes, touches, or subpackage usage.
