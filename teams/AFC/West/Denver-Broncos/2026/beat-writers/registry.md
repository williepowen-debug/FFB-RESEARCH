---
schema_version: 1
record_id: bw-2026-den-registry-001
record_type: beat_writer_registry
title: "Denver Broncos 2026 Source Registry"
team_ids: ["DEN"]
player_ids: []
season: 2026
week: null
...
|---|---|---|---|---|
| Denver Broncos communications | Broncos | official | Roster, injuries, transactions, depth chart and conferences | Team analysis is not independent |
| NFL gamebooks and participation | NFL | official | Participation and game records | Preferred postgame record |
| Jeff Legwold | ESPN NFL Nation | reporting | Daily beat, injuries, roster and league context | ESPN verifies assignment |
| Nick Kosmider | The Athletic | reporting | Practice, scheme, roster construction and organization | Paywalled; summarize and attribute |
| Parker Gabriel | The Denver Post | reporting | Daily camp, injuries, roles and personnel | Paywalled; summarize and attribute |
| Mike Klis | 9NEWS | reporting | Organization, transactions, injuries and breaking news | Separate sourced reporting from analysis |

## Valuable monitoring

| Source | Outlet | Class | Primary value | Handling note |
|---|---|---|---|---|
| Zac Stevens | DNVR | reporting | Camp observations, role battles and local context | Separate reporting from show opinion |
...
- Strongest coverage areas: injuries, practice reps, offensive roles, contracts, organization and
  defensive deployment.
- Known limitations: paywalls and mixed reporting, columns, podcasts and radio formats.
...
Use official reports for transactions and availability. Corroborate camp-role conclusions across
independent observers and confirm with preseason or regular-season usage.
