---
schema_version: 1
record_id: rf-2026-ari-backfield-target-hierarchy-001
...
# Finding: Skill talent is clearer than touch distribution

## Scope

- Team/player: Cardinals skill-position ecosystem
...
The August 17 official depth chart listed Tyler Allgeier first at running back, followed by
...
Love's draft capital and first-half preseason usage create a lead-back ceiling, but Allgeier's
depth-chart placement, Conner's status, and Love's ankle soreness keep the early workload
unresolved. Benson's removal narrows the competition without deciding its order. The passing-game
top end is cleaner: Harrison and McBride should be the first reads most likely to carry fantasy
starter value, while Bourne/Wilson and the reserve receiver battle shape weekly volatility.
...
- Arizona Cardinals - [2026 transactions](https://www.azcardinals.com/team/transactions/2026) -
  Benson waived/injured 2026-08-24; verified 2026-08-25.
...
- Confidence: medium
- Reason: depth-chart and transaction facts are official; workload shares remain preseason assumptions.
- Fact/inference boundary: draft slot, depth chart, injuries, and preseason touches are facts. Target/touch hierarchy is inference.
- What would invalidate this: Love misses extended time, Allgeier clearly owns starter snaps,
  Conner returns ahead of Love, or Bourne/Wilson lose routes to Brooks/Virgil/Fehoko.
- Next review: final 53-man roster, Week 1 inactive list, and first two regular-season snap/route reports.
