---
schema_version: 1
record_id: to-2026-ari-overview-001
...
Arizona changed head coach and offensive coordinator, moved on from Murray, added Brissett and Minshew, and drafted Beck in Round 3. LaFleur arrived from the Rams after three seasons as offensive coordinator. Hackett arrived with a long coordinator history and a 2025 Packers defensive analyst stop.

The official preseason depth chart and team reporting create the initial usage baseline: Brissett is QB1, Allgeier is first at running back, Love is a high-draft-capital rookie with immediate preseason touches, and McBride/Harrison are the most stable passing-game assets.

### Inference

The scheme prior is Shanahan/McVay-family structure blended with Hackett's quarterback/red-zone background. That supports high-value touches for backs and tight ends, but the team still needs regular-season proof in pass rate, pace, and red-zone concentration.

## Defensive matchup profile

### Facts

Rallis remains coordinator, while Arizona changed the defensive front through releases, veteran additions, draft additions, and injuries. The official depth chart lists a defense built around Darius Robinson, Roy Lopez, Walter Nolen III, Jordan Burch, Cody Simon, Mack Wilson Sr., Zaven Collins, Baron Browning, Denzel Burke, Max Melton, Will Johnson, Sean Murphy-Bunting, Andrew Wingard, and Baker.

### Inference

The defense is more projectable than the offense because the coordinator stayed. The matchup question is whether the front can win without Proctor and with changed interior depth. Coverage should not be treated as a hard downgrade for opposing pass catchers until the young corner group proves it in regular-season games.

## Coaching and scheme

| Unit | 2025 | 2026 |
|---|---|---|
| Head coach | Jonathan Gannon | Mike LaFleur |
| Offensive coordinator | Drew Petzing | Nathaniel Hackett |
| Defensive coordinator | Nick Rallis | Nick Rallis |
| Special teams coordinator | Jeff Rodgers | Michael Ghobrial |

The offensive staff is new enough that the first month of 2026 should override imported coach-history assumptions. The defensive staff carries more continuity through Rallis, but the personnel churn keeps the front-seven projection at medium confidence.

## Special teams

Michael Ghobrial is the new special teams coordinator. Chad Ryland, Blake Gillikin, and Casey Kreiter are listed as kicker, punter/holder, and long snapper on the official depth chart. Devin Duvernay is listed first at kick returner and punt returner.

## Current depth chart

Use the generated [schedule](schedule.md) for game timing only. A current weekly depth chart has not been created in this Core module. The official Cardinals depth chart was used as the preseason baseline for this overview.
...
- Does Baker keep high tackle volume next to Wingard and the young corners?

## Sources

- Arizona Cardinals - [Transactions](https://www.azcardinals.com/team/transactions/2026) - verified 2026-08-17.
- Arizona Cardinals - [Coaching Staff](https://www.azcardinals.com/team/coaches-roster/) - verified 2026-08-17.
- Arizona Cardinals - [Official Depth Chart](https://www.azcardinals.com/team/depth-chart) - verified 2026-08-17.
- Arizona Cardinals - [2026 Draft Tracker](https://www.azcardinals.com/news/draft/2020/2026/) - verified 2026-08-17.
...
- Arizona Cardinals - [Mike LaFleur coach bio](https://www.azcardinals.com/team/coaches-roster/mike-lafleur) - verified 2026-08-17.
- Arizona Cardinals - [Nathaniel Hackett coach bio](https://www.azcardinals.com/team/coaches-roster/nathaniel-hackett) - verified 2026-08-17.
