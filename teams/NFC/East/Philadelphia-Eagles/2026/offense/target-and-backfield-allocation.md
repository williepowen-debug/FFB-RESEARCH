---
schema_version: 1
record_id: rf-2026-phi-target-backfield-allocation-001
record_type: research_finding
title: "Brown trade opens targets, but Eagles added enough receivers to keep roles unsettled"
team_ids: ["PHI"]
...
# Finding: Brown trade opens targets, but Eagles added enough receivers to keep roles unsettled

## Scope

- Team/player: Eagles skill-position offense
...
- Smith has the cleanest path to target leadership and should be treated as the Eagles receiver baseline.
- Lemon is the priority rookie monitor because Round 1 capital plus first-depth-chart placement can turn into immediate fantasy relevance.
- Wicks has an important path because of Mannion familiarity and a first-team listing, but Brown and Moore can cap weekly certainty.
- Goedert remains the veteran tight end starter, while Stowers is more important for dynasty and tight end premium unless early routes spike.
- Barkley remains a high-end RB projection, but early charting should separate carries, routes, targets, and goal-line work.

## Evidence

- The Eagles' transactions page records the A.J. Brown trade to New England on June 1, 2026.
...
- The August 25 public-practice notebook records Lemon scoring on a Hurts pass from a backfield
  alignment during a red-zone team period.
...
- Philadelphia Eagles - [Public Practice Notes](https://www.philadelphiaeagles.com/news/eagles-public-practice-notes-riq-woolen-leads-the-defense-in-front-of-45-000-fans) - published 2026-08-25.
