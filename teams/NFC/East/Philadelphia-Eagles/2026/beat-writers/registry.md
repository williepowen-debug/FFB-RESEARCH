...
source_ids: []
supersedes: []
writer_ids: ["local-writer-tim-mcmanus", "local-writer-olivia-reiner", "local-writer-jeff-neiburg", "local-writer-dave-zangaro"]
---

# Philadelphia Eagles 2026 Source Registry

See [sources.csv](sources.csv), [endpoints.csv](endpoints.csv), and the
